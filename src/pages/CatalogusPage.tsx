  ...
  return (
    <>
      <div className='catalogus-page'>
        ...
        <p>Hier vindt u de complete catalogus van Speelotheek Woerden. Mail ons met je aanvragen als je iets zou willen reserveren kosten zijn €0,50 per artikelen. </p>
